...
//    [NSBundle bundleWithURL:[[NSBundle bundleForClass:[self class]] URLForResource:@"iosMathFonts" withExtension:@"bundle"]]
    NSURL *url = [[NSBundle mainBundle] URLForResource:@"iosMathFonts" withExtension:@"bundle"];
